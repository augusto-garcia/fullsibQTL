...
These can be easily accessed within R:
...
`onemap` package. There is details about it at `onemap`
...
information for the markers, and 2 phenotypic traits. This file is
