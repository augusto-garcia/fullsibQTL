...
If your onemap raw data do not have phenotypic information, you can also use here a matrix with individuals in rows and traits in columns. See example:
...
The individuals in the rows must be the same as the ones used to build the linkage map, specified in the third row of onemap raw file. If you do not have phenotypic information for all of them, complete their rows with `NA`.
