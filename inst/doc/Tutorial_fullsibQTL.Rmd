...
| summaries                  | `print`                    | class `fullsib`: Prints a summary for the object of class fullsib                              |
| class name in              | `print`                    | class `fullsib_scan`: Prints the result of im_scan or cim_scan                                 |
