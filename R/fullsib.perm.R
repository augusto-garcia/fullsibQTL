...
#                                                                     # 
# Contains:                                                           #
# summary.fullsib.perm                                                #
# plot.fullsib.perm                                                   #
#                                                                     #
# Written by Rodrigo Gazaffi                                          #
# copyright (c) 2011, Rodrigo Gazaffi                                 #
# summary.fullsib.perm is based on summary.scanoneperm from qtl pkg   #
# plot.fullsib.perm    is based on plot.scanoneperm from qtl package  #
#                                                                     #
...
summary.fullsib.perm <- function(object,
                                 alpha=c(0.05, 0.10), ...)
{
...
plot.fullsib.perm <- function(x, peak=1, ...)
{
